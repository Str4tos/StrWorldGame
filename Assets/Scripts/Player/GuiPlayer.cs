...
public class GuiPlayer : MonoBehaviour
{
    ...
    private BagInventory invBag;
    private CharacterInventory invCharacter;
    private StorageInventory invStorage;
    private ShopInventory invShop;
    private CraftingInventory invCrafting;
    private Tooltip toolTip;

    private MenuPlayer playerMenu;
    ...
    public CraftingInventory InvCrafting
    {
        get { return invCrafting; }
        set { invCrafting = value; }
    }
    public StorageInventory InvStorage
    {
        get { return invStorage; }
        set { invStorage = value; }
    }
    public CharacterInventory InvCharacter
    {
        get { return invCharacter; }
        set { invCharacter = value; }
    }
    public BagInventory InvBag
    {
        get { return invBag; }
        set { invBag = value; }
    }
    public ShopInventory InvShop
    {
        get { return invShop; }
        set { invShop = value; }
    }
    ...
    void Awake()
    {
        ...
        playerMenu = GameObject.Find("MainCanvas/GeneralMenu").GetComponent<MenuPlayer>();

		invBag = GameObject.FindWithTag("InvBag").GetComponent<BagInventory>();
		invStorage = GameObject.FindWithTag("InvStorage").GetComponent<StorageInventory>();
		invShop = GameObject.FindWithTag("InvShop").GetComponent<ShopInventory>();
		invCrafting = GameObject.FindWithTag("InvCrafting").GetComponent<CraftingInventory>();
		invCharacter = GameObject.FindWithTag("InvCharacter").GetComponent<CharacterInventory>();
